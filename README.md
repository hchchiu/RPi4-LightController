...
透過[Google API Console](https://console.developers.google.com/)或是[Google Cloud Speech-to-txt Doc](https://cloud.google.com/speech-to-text/docs/quickstart-client-libraries)申請Google Cloud Speech API金鑰，並且將金鑰檔案(JSON File)路徑設定到環境變數中
```bash
